...
class BaseDao{
    ...
    Public Function RecuperaBanco($codSistema){
        $sql = "SELECT NME_BANCO FROM EN_SISTEMAS WHERE COD_SISTEMA = $codSistema";
        return static::selectDB($sql, false);
    }
    
    Public Function RetornaUsuarioBanco($codUsuario, $nmeBanco){
        $sql = "SELECT NME_USUARIO FROM ".$nmeBanco.".SE_USUARIO WHERE COD_USUARIO = ".$codUsuario;
        return static::selectDB($sql, false);
    }
}
?>
