...
class UsuarioDao extends BaseDao
{
    ...
    Public Function ListarUsuario(){
        $sql = "SELECT U.COD_USUARIO,
                       ...
                       P.DSC_PERFIL,
                       U.IND_ATIVO,
                       GROUP_CONCAT(US.COD_SISTEMA) COD_SISTEMA
                  FROM SE_USUARIO U
                 INNER JOIN SE_PERFIL P
                    ON U.COD_PERFIL = P.COD_PERFIL
                  LEFT JOIN RE_USUARIO_SISTEMA US 
    ...
    Public Function InsereUsuarioSistema($codUsuario, $codSistema){
        $sql = "INSERT INTO RE_USUARIO_SISTEMA (COD_USUARIO, COD_SISTEMA) VALUES ($codUsuario, $codSistema)";
        $this->insertDB($sql);
    }
}
